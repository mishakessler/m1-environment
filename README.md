# M1 Chip Environment Setup <!-- omit in toc -->

**An extremely thorough guide to setting up a powerful software engineering Unix environment on the new Apple M1 chip.**
...
I will use these dropdowns to keep the guide relatively clean and focused on installation steps, but to still include: 

1. Important context about what is happening with each download, and
1. Important notes on possible errors.

If you find yourself curious about what is actually happening with each step, or have an error that you can't get around, just check them out!
